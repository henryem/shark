...
class SerializationSuite extends FunSuite {
  ...
  //FIXME: Test is no longer relevant, but a similar test should be written for
  // SerializableObjectInspector.
...
//  }
  ...
  //FIXME: Test is no longer relevant, but a similar test should be written
  // using ordinary Java serialization.
